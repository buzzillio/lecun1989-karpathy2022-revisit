...
if __name__ == '__main__':
    ...
    optimizer = optim.AdamW(model.parameters(), lr=5e-3, weight_decay=0.01, betas=(0.9, 0.95))
    scheduler = LinearWarmupCosineAnnealingLR(optimizer, warmup_epochs=5, max_epochs=80)
    ...
    for pass_num in range(80):
        ...
        print(f"{pass_num + 1} (lr: {current_lr:.6f})")
        eval_split('train')
        eval_split('test')
        writer.add_scalar('lr', current_lr, pass_num)
